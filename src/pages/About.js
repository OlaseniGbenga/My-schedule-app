export default function About() {
  return (
    <div className=" bg-c-blue flex gap-2 flex-col px-16 flex-">
      <h1 className="text-2xl bold text-center text-green-600 font-bold ">About</h1>
...
Thank you for choosing our app for your to-do list needs. We hope our app helps you stay organized and on top of your tasks. If you have any feedback or suggestions, feel free to contact us.</p>
    </div>
  );
}
